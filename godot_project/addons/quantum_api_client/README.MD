...
```ini
[quantum_api]
base_url="https://davidjgrimsley.com/public-facing/api/quantum-gateway"
backend_proxy_mode=true
direct_api_key=""
gateway_project_id="echos-of-light"
default_ibm_profile=""
```
...
- `gateway_project_id`: sent as `X-Project-Id` on protected runtime calls
